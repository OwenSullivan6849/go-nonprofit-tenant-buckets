...
> Design notes for **go-nonprofit-tenant-buckets** — a runnable go example that Go example for tenant-isolated nonprofit receipts and reporting scopes.
...
- **Feature code** — the actual task: tenant-receipt-storage.
